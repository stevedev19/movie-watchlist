...
```
mongodb+srv://abdullatoshtemirov:XRUjTH5tw1uaHz3i@cluster0.ruwrd2y.mongodb.net/MovieWatchlist
```
...
1. Make sure your `.env.local` file has:
   ```env
   MONGODB_URI=mongodb+srv://abdullatoshtemirov:XRUjTH5tw1uaHz3i@cluster0.ruwrd2y.mongodb.net/MovieWatchlist
   ```
